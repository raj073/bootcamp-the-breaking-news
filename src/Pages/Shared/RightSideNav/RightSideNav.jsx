  ...
  return (
    <div>
      ...
      <div className="p-4 mb-6">
        ...
        <Link className="p-4 flex text-lg items-center border rounded-tl-md">
          <FaFacebook className="mr-2 text-blue-700"></FaFacebook> Facebook
        </Link>
        <Link className="p-4 flex text-lg items-center border-x">
          <FaTwitter className="mr-2"></FaTwitter> Twitter
        </Link>
        <Link className="p-4 flex text-lg items-center border rounded-br-md">
